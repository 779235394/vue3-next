 ...
 * @Descripttion:
 * @Author: huangzihong
 * @Date: 2022-03-07 14:31:59
 * @LastEditors: huangzihong
 * @LastEditTime: 2022-03-07 14:42:36
 */
...
export const createSvg = (path: any, perfix = 'icon') => {
  ...
  return {
    ...
    transformIndexHtml(dom: String) {
      return dom.replace('<body>', `<body><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position: absolute; width: 0; height: 0">${res.join('')}</svg>`)
    },
  }
}

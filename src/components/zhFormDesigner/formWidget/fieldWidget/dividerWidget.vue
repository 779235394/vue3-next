 ...
 * @Descripttion:
 * @Author: huangzihong
 * @Date: 2022-03-10 16:58:44
 * @LastEditors: huangzihong
 * @LastEditTime: 2022-03-10 17:01:07
-->
<template>
...
const rules: any = ref([])
const { registerToRefList, initEventHandler, handleOnCreated, handleOnMounted, unregisterFromRefList } = fieldHock({ field, parentWidget, designState, subFormRowIndex, fieldModel, oldFieldValue, subFormRowId, rules })
onBeforeMount(() => {
  registerToRefList()
  initEventHandler()
  handleOnCreated()
